...
- `src/embedding.ts` — Compartment extraction, OpenAI embedding calls, embedding cache I/O, runtime index.
...
- **Embedding caches** (one JSON per note) for embedding storage.
